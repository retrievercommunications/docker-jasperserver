...
RUN wget "https://sourceforge.net/projects/jasperserver/files/JasperServer/JasperReports%20Server%20Community%20Edition%20${JASPERSERVER_VERSION}/jasperreports-server-cp_${JASPERSERVER_VERSION}_bin.zip/download" \
...
# ADD jasperreports-server-cp-6.1.0-bin.zip /tmp/jasperserver.zip
